...
$myactivity = data("SELECT * FROM myactivity");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" <?= baseurl ?> " target="_blank">
          <img src="<?=baseurl;?>/assets/img/<?= $user["foto"];?>" class="navbar-brand-img h-100" alt="main_logo"/>
          <span class="ms-1 font-weight-bold text-white">Fitri Ramadhani</span>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse w-auto max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link text-white" href="?menu=user">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="?menu=myactivity">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
