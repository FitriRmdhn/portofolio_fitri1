...
<body class="bg-gray-200">
  <main class="main-content mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('https://media-assets-ggwp.s3.ap-southeast-1.amazonaws.com/2022/03/GojoSatoru3.jpg');">
          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-danger shadow-success border-radius-lg py-3 pe-1">
                  <a href="<?=baseurl;?>">
                    <h3 class="text-white font-weight-bolder text-center mt-2 mb-0">welcome</h3>
                  </a>
                </div>
              </div>
              <div class="card-body">
                <form action="" method="POST" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" name="login" class="btn bg-danger w-100 my-4 mb-2">Sign in</button>
                  </div>
                </form>
              </div>
            </div>
